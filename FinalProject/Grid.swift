...
public enum CellState: String, CustomStringConvertible {
    case alive = "alive" , empty = "empty" , born = "born" , died = "died" //I know this is redundant
    ...
    public func toggle(value: CellState) -> CellState {
        //when passed .empty or .died, returns .alive, when passed .alive or .born returns .empty
        switch value{
        case .alive, .born:
            return .empty
        case .empty, .died:
